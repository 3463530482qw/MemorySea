...
/* yok 后缀优先于 lua：require 时先找 ?.yok，再找 ?.lua */
#define LUA_PATH_DEFAULT  \
		LUA_LDIR"?.yok;"  LUA_LDIR"?.lua;"  LUA_LDIR"?\\init.yok;"  LUA_LDIR"?\\init.lua;" \
		LUA_CDIR"?.yok;"  LUA_CDIR"?.lua;"  LUA_CDIR"?\\init.yok;"  LUA_CDIR"?\\init.lua;" \
		LUA_SHRDIR"?.yok;" LUA_SHRDIR"?.lua;" LUA_SHRDIR"?\\init.yok;" LUA_SHRDIR"?\\init.lua;" \
		".\\?.yok;" ".\\?.lua;" ".\\?\\init.yok;" ".\\?\\init.lua"
#endif
